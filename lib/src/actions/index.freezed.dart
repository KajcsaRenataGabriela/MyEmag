...
mixin _$CreateUser {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String email, String password) start,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String email, String password)? start,
...
class _$CreateUserStart implements CreateUserStart {
  const _$CreateUserStart({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'CreateUser.start(email: $email, password: $password)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return start?.call(email, password);
  }
...
abstract class CreateUserStart implements CreateUser {
  const factory CreateUserStart(
      ...
      required final String password}) = _$CreateUserStart;
...
class _$LoginUserStart implements LoginUserStart {
  const _$LoginUserStart({required this.email, required this.password});
  ...
  @override
  String toString() {
    return 'LoginUser.start(email: $email, password: $password)';
  }
...
abstract class LoginUserStart implements LoginUser {
  const factory LoginUserStart(
      {required final String email,
      required final String password}) = _$LoginUserStart;
...
abstract class CheckUserSuccessful implements CheckUser {
